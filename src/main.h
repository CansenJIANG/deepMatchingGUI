...
const char* parse_options(dm_params_t *params, scalerot_params_t *sr_params, \
                          bool *use_scalerot, float *fx, float *fy, const int argc, \
                          const char **argv, const int language, \
